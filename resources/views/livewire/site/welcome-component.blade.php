...
<div class="services-area pt-120 pt-md-60 pt-xs-60 pb-100 pb-xs-50 home-5">
    <div class="container">
        <div class="rts-heading">
            <div class="title-inner">
                ...
                <div class="title">We Offer a Leading<br>
                    <b>IT Solution</b> World Wide</div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="faq-area">
            <h3 class="ques-text">
                Are you a driven and motivated 1st Line IT Support Engineer? <a href="index-5.html#">Now Hiring!</a>
            </h3>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blogs mb-30">
                    ...
                    <div class="blogs__content">
                        ...
                        <div class="btn-part">
                            <a href="index-5.html#" class="readon-arrow">Read More <i class="fa fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
