...
<!-- Core CSS -->
<link rel="stylesheet" href="{{ asset('assets/dash/assets/vendor/css/rtl/core.css') }}"
 />
...
<link rel="stylesheet"
    href="{{ asset('assets/dash/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}">
<link rel="stylesheet"
    href="{{ asset('assets/dash/assets/vendor/libs/datatables-checkboxes-jquery/datatables.checkboxes.css') }}">

<!-- Page CSS -->
<link rel="stylesheet" href="{{ asset('assets/dash/assets/vendor/css/pages/cards-advance.css') }}" />

<link rel="stylesheet" href="{{ asset('assets/dash/assets/vendor/css/rtl/theme-default.css') }}" />
<!-- Helpers -->
