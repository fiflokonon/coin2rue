...
<div>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard/Formations/</span> Modifier une
            formation</h4>
        ...
        <div class="card mb-4">
            <div class="p-3">
                ...
                <h5 class="card-header d-inline">Modifier une formation</h5>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" class="form-control" placeholder="prix de la formation"
                                    wire:model="prix" />
                            </div>
                        </div>
                    </div>
